...
import convoyBackground from "@/assets/convoy-background.jpg";
    ...
    <div className="w-full py-20 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-6 bg-gradient-to-r from-white via-white to-white/80 bg-clip-text text-transparent">
