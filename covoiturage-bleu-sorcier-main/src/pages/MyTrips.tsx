                                  ...
                                  <div key={reservation.id} className="flex items-center gap-2">
                                    <Avatar className="w-6 h-6">
                                      ...
                                      <AvatarFallback className="text-xs">
                                        {reservation.passenger.split(' ').map(n => n[0]).join('')}
                                      </AvatarFallback>
                                    </Avatar>
                      ...
                      <div className="flex flex-col lg:flex-row gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-3">
                            <div className="flex items-center gap-2">
                              <MapPin className="w-4 h-4 text-primary" />
                              <span className="font-semibold text-foreground">{reservation.departure}</span>
                            </div>
                            <div className="w-6 h-px bg-border"></div>
                            <div className="flex items-center gap-2">
                              <MapPin className="w-4 h-4 text-primary" />
                              <span className="font-semibold text-foreground">{reservation.destination}</span>
                            </div>
                          ...
                          <div className="flex items-center gap-3">
                            <Avatar className="w-8 h-8">
                              ...
                              <AvatarFallback>
                                {reservation.driver.name.split(' ').map(n => n[0]).join('')}
                              </AvatarFallback>
                            </Avatar>
                            <div>
                              <div className="font-medium text-foreground">{reservation.driver.name}</div>
