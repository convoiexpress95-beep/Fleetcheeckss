    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          onPress={() => navigation.navigate('Outils' as never)}
        />
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          title="Facturation"
          subtitle="Crédits et factures"
          onPress={() => navigation.navigate('Billing' as never)}
        />
        <SettingItem
          icon="document-text-outline"
          title="Rapports"
          subtitle="Générer et consulter"
          onPress={() => navigation.navigate('Reports' as never)}
        />
        <SettingItem
          icon="people-outline"
          title="Contacts"
          subtitle="Gérer vos relations"
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          onPress={() => Linking.openURL('https://app.fleetcheck.fr')}
        />
        ...
        <SettingItem
          ...
          onPress={() => Linking.openURL('mailto:support@fleetcheck.fr')}
        />
