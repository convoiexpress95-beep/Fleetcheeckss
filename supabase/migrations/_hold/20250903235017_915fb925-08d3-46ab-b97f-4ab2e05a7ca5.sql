-- Nettoyer et recréer la structure complète
DROP VIEW IF EXISTS public.contacts_with_stats CASCADE;
...
DROP FUNCTION IF EXISTS public.search_profiles_by_email(TEXT) CASCADE;
...
CREATE FUNCTION public.search_profiles_by_email(query TEXT)
