...
import { Star, Shield, Car, Camera, Edit, MapPin, Mail, Phone } from "lucide-react";
...
const Profile = () => {
  const user = {
    ...
    totalReviews: 42,
    completedTrips: 87,
    bio: "Passionnée de voyages et de rencontres, j'aime partager mes trajets.",
    location: "Paris, France",
    preferences: { music: true, pets: false, smoking: false, chatty: true },
    car: { model: "Peugeot 308", color: "Bleu", year: 2020, seats: 4 },
  };

  const recentReviews = [
    { id: "1", reviewer: "Thomas Martin", rating: 5, comment: "Excellente conductrice.", date: "Il y a 2 jours", trip: "Paris → Lyon" },
    { id: "2", reviewer: "Sophie Bernard", rating: 5, comment: "Super voyage !", date: "Il y a 1 semaine", trip: "Lyon → Marseille" },
  ];
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex flex-col items-center">
                    <div className="relative">
                      ...
                      <Button size="icon" variant="outline" className="absolute bottom-0 right-0 rounded-full w-10 h-10">
            ...
            <Card className="glass-card border border-border/50 shadow-card">
              ...
              <CardContent>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="font-semibold">{user.car.model}</div>
                  ...
                  <div key={review.id}>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-muted-foreground">Trajet : {review.trip}</div>
                      </div>
                    </div>
                    {review.id !== recentReviews[recentReviews.length - 1].id && <Separator className="mt-6" />}
                  </div>
                ))}
              </CardContent>
            </Card>
